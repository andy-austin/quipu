...
Skills are specialized prompt templates that provide Claude Code with deep domain expertise or workflow-specific
knowledge. They extend Claude's capabilities beyond general programming assistance.
...
**Description:** Expert guide for Nightingale web components - protein sequence and biological data visualization
library.
